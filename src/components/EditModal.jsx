...
export function EditModal({destination}) {
     const {_id, imageUrl, destinationName, description, price, duration, country, category, departureDate } = destination;
    
    
     // --- MongoDB URL: Call the API route to add a new destination ----
  ...
  return (
    <Modal>
      <div className=''>
        <Button variant='outline' className={'rounded-none my-5 '}><BiEdit />Edit</Button>
       </div>
      <Modal.Backdrop>
